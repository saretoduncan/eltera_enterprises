        ...
        <div className="2xl:w-[1280px] 2xl:mx-auto">
          <div className="space-y-4 my-4">
            ...
            <p className="text-sm lg:text-base">
              ...
              envisions a future where we are the leading provider of innovative
              and sustainable transportation solutions, connecting businesses
              and communities across Kenya while driving economic growth and
