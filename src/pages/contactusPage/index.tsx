...
const ContactUsPage = () => {
  ...
  return (
    <div className="mt-[150px] mb-[100px] lg:my-[200px] px-6 max-w-[1280px] mx-auto ">
      <div className=" flex flex-col-reverse lg:grid lg:grid-cols-2 lg:relative ">
        <div
          ref={ref}
          className={`"translate-all duration-700 h-[300px] lg:h-auto bg-cover relative ${
            inView
              ? "top-0 lg:top-4 lg:opacity-100"
              : "top-16 lg:top-16 lg:opacity-0"
          }  lg:left-4 lg:z-[-1] lg:rounded-lg rounded-b-md"`}
          style={{
        ...
        <AnimateToBottom>
          <div className="grid bg-primaryBlue min-h-[300px] text-white p-4 gap-4 lg:rounded-lg rounded-t-lg">
            <h3 className="uppercase font-bold text-2xl text-auto">
              Contact us
            </h3>
            <h4 className="text-xl font-bold text-orange-500">Get In Touch</h4>
            <p className="font-bold">
              For inquiries, quotes, or more information, feel free to reach
              out. Our team is here to assist you with all your transport and
              logistics needs.
            </p>
