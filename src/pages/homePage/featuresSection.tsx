      ...
      <div className="my-6">
        <div className="grid px-4  md:grid-cols-2 xl:w-[1280px] mx-auto">
          ...
          <section className="bg-primaryBlue ">
            <div
              className="bg-cover bg-no-repeat  text-gray-200 px-6 space-y-4 py-4  h-full lg:p-10 md:items-center"
            ...
            >
              ...
              <article className=" text-sm md:text-base">
                At Eltera Enterprises, we are committed to delivering dependable
                and efficient transport services you can count on. Our fleet of
                heavy duty lorries is equipped to ensure your goods are
                transported securely and punctually. Whether your shipment needs
                to travel within Kenya or reach destinations across the country,
                you can rely on us to deliver every time.
              </article>
            </div>
          </section>
        </div>
        <div className="grid px-4  md:grid-cols-2 xl:w-[1280px] mx-auto grid-cols-reverse">
          ...
          <section className="bg-white ">
            <div
              className="bg-cover bg-no-repeat  text-gray-700 px-6 space-y-4 py-4  h-full lg:p-10"
              style={{ backgroundImage: "url(" + "'" + lightBgSvg + "'" + ")" }}
            >
              <h3 className="text-xl font-bold lg:text-3xl ">
              ...
              <article className=" text-sm md:text-base">
                At Eltera Enterprises, we offer transportation servicea all over
                Kenya with our fleet of heavy-duty lorries. Our extensive
                coverage area ensures that we reach even the most remote
                locations.
              </article>
              <div>
                <TertiaryLinkButton
